...
//SNRD
//URLsnr
$baseURL = "http://localhost/www.pliegos.net/maker/GerritNoordzij/cubNoordzij.php";  // execució recursiva al localhost del MacbookAir
// EP! aquí podem posar-hi o no les 3 www al davant
//$baseURL = "http://pliegos.net/maker/GerritNoordzij/cubNoordzij.php";  // execució recursiva al servidor de Teixidora
